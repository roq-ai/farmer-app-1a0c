...
import { FinancialStatementListPage } from 'pages/financial-statements';
import { PurchaseListPage } from 'pages/purchases';
import { SaleListPage } from 'pages/sales';
import { VisitListPage } from 'pages/visits';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('farm', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/farms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="farm" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
