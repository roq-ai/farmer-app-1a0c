  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Navigate your farming business with ease using Farmer App - Your ultimate tool for tracking purchases, sales, scheduling visits, and reviewing financial statements."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605000797499-95a51c5269ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmYXJtaW5nfGVufDB8fHx8MTY5NDU2NjI4MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@timmossholder?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Tim Mossholder`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Navigate your farming business with ease using Farmer App - Your ultimate tool for tracking purchases, sales, scheduling visits, and reviewing financial statements.`}
            </Text>
            <Box
